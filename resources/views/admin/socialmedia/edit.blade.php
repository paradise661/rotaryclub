                ...
                <form method="POST" action="{{ route('admin.socialmedias.update', $socialmedia->id) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                            value="{{ old('title', $socialmedia->title) }}" name="title" id="" placeholder="">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('link') is-invalid @enderror"
                            value="{{ old('link', $socialmedia->link) }}" name="link" id="" placeholder="">
                        @error('link')
                            <div class="invalid-feedback" style="display: block;">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('icon') is-invalid @enderror"
                            value="{{ old('icon', $socialmedia->icon) }}" name="icon" id="" placeholder="">
                        @error('icon')
                            <div class="invalid-feedback" style="display: block;">
                                {{ $message }}
                            </div>
